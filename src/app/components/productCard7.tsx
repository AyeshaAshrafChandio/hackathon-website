...
<div className="sm:w-full md:w-[80%] sm: p-5 md:p-5 sm:h-auto md:h-[400px] flex sm: flex-col md:flex-row sm: justify-star md:justify-center sm:items-start md:items-center bg-black"></div>
 <div className="sm:w-full md:w-[50%] p-4">
<h3 className="text-green-500 font-bold" > Categories</h3>
<h1 className="text-white font-bold sm: text-md md:text-3x1 1g:text-5x1 pt-4"> Enhance Your</h1> 
<h1 className='text-white font-bold sm:text-md md:text-3x1 1g:text-5x1 pt-4'> Music Experience</h1>
...
<button className="bg-green-600 ☐hover:bg-green-800 sm:hidden md:block sm:px-3 md: px-7 sm:text-sm py-0 ■text-white font-bold rounded-sm h-10 mt-3"> Buy Now! </button>
{/*Image*/}
<div className="sm:w-full md:w-[40%] lg:w-[40%] pl-6 justify-center items-center">
<img src="../music.png" alt="music spaker"
